...
<nav class="w3-sidebar w3-bar-block w3-white w3-collapse" style="z-index:3;width:250px" id="mySidebar">
  <div class="w3-container w3-display-container w3-padding-16">
    ...
    <h3 class="w3-wide"><font size="3"><?php echo $greeting ?> <i class="fa fa-gamepad fa-2x"></i></font></h3>
...
<div class="w3-main" style="margin-left:250px">
  ...
  <?php
  $i = 0;
	$product_array = $db_handle->runQuery("SELECT * FROM games WHERE game_type = 'simulation' OR game_type = 'role-playing' ORDER BY game_type DESC");
  ...
  <div class="w3-row">
    <div class="w3-col l3 s6">
      <div class="w3-container">
        ...
        <form method="post" action="simulation.php?action=add&game_ID=<?php echo $product_array[0]["game_ID"]; ?>">
        <img src="<?php echo $product_array[0]["image"]; ?>" style="width:100%">
          
        <font size="3"><input type="text" class="product-quantity" name="quantity" value="1" size="1" /><input type="submit" value="Add to Cart" class="w3-button w3-black w3-margin-top" />
          </form>          
    ...
    <div class="w3-container">
      <div class="w3-display-container">
      <form method="post" action="simulation.php?action=add&game_ID=<?php echo $product_array[4]["game_ID"]; ?>">
      <img src="<?php echo $product_array[4]["image"]; ?>" style="width:100%">
        
        <input type="text" class="product-quantity" name="quantity" value="1" size="2" /><input type="submit" value="Add to Cart" class="w3-button w3-black w3-margin-top" />
        </form>          
  ...
  <div class="w3-col l3 s6">
    <div class="w3-container">
      <div class="w3-display-container">
      <form method="post" action="simulation.php?action=add&game_ID=<?php echo $product_array[1]["game_ID"]; ?>">
    ...
    <div class="w3-container">
    <form method="post" action="simulation.php?action=add&game_ID=<?php echo $product_array[5]["game_ID"]; ?>">
    ...
    <div class="w3-col l3 s6">
      <div class="w3-container">
      <form method="post" action="simulation.php?action=add&game_ID=<?php echo $product_array[2]["game_ID"]; ?>">
    <img src="<?php echo $product_array[2]["image"]; ?>" style="width:100%">
      ...
      <div class="w3-container">
        <div class="w3-display-container">
        <form method="post" action="simulation.php?action=add&game_ID=<?php echo $product_array[6]["game_ID"]; ?>">
    ...
    <div class="w3-col l3 s6">
      <div class="w3-container">
      <form method="post" action="simulation.php?action=add&game_ID=<?php echo $product_array[3]["game_ID"]; ?>">
    <img src="<?php echo $product_array[3]["image"]; ?>" style="width:100%">
      ...
      <div class="w3-container">
      <form method="post" action="simulation.php?action=add&game_ID=<?php echo $product_array[7]["game_ID"]; ?>">
