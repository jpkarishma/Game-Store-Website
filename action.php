...
<div class="w3-main" style="margin-left:250px">
  ...
  <div class="w3-container w3-text-grey" id="jeans">
    <p><b>Action Games</b></p>
	<p><b>8 items</b></p>
  </div>

  <?php
  $i = 0;
	$product_array = $db_handle->runQuery("SELECT * FROM games WHERE game_type = 'action' OR game_type = 'FPS' OR game_type = 'Fighter' ORDER BY game_name");
