...
<div class="w3-main" style="margin-left:250px">
  ...
  <?php
  $i = 0;
	$product_array = $db_handle->runQuery("SELECT * FROM games WHERE game_type = 'FPS' OR game_type = 'action' OR game_type = 'role-playing' ORDER BY game_name");
  ...
  <div class="w3-row">
    <div class="w3-col l3 s6">
      <div class="w3-container">
        ...
        <form method="post" action="shooter.php?action=add&game_ID=<?php echo $product_array[0]["game_ID"]; ?>">
    ...
    <div class="w3-container">
      <div class="w3-display-container">
      <form method="post" action="shooter.php?action=add&game_ID=<?php echo $product_array[4]["game_ID"]; ?>">
  ...
  <div class="w3-col l3 s6">
    <div class="w3-container">
      <div class="w3-display-container">
      <form method="post" action="shooter.php?action=add&game_ID=<?php echo $product_array[1]["game_ID"]; ?>">
    ...
    <div class="w3-container">
    <form method="post" action="shooter.php?action=add&game_ID=<?php echo $product_array[5]["game_ID"]; ?>">
    ...
    <div class="w3-col l3 s6">
      <div class="w3-container">
      <form method="post" action="shooter.php?action=add&game_ID=<?php echo $product_array[2]["game_ID"]; ?>">
    <img src="<?php echo $product_array[2]["image"]; ?>" style="width:100%">
      ...
      <div class="w3-container">
        <div class="w3-display-container">
        <form method="post" action="shooter.php?action=add&game_ID=<?php echo $product_array[6]["game_ID"]; ?>">
    ...
    <div class="w3-col l3 s6">
      <div class="w3-container">
      <form method="post" action="shooter.php?action=add&game_ID=<?php echo $product_array[3]["game_ID"]; ?>">
    <img src="<?php echo $product_array[3]["image"]; ?>" style="width:100%">
      ...
      <div class="w3-container">
      <form method="post" action="shooter.php?action=add&game_ID=<?php echo $product_array[7]["game_ID"]; ?>">
