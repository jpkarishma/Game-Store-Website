<?php
  ...
  $game_id_err = $game_name_err = "";
    ...
    if($_SERVER["REQUEST_METHOD"] == "POST"){
        ...
        if(empty($game_name_err) && empty($game_id_err))
        {
            ...
            {
                // Bind variables to the prepared statement as parameters
                mysqli_stmt_bind_param($stmt, 'ss', $game_id, $game_name);
                // Set parameters
                $game_name = trim($_POST["game_name"]);
                ...
                if(!mysqli_stmt_execute($stmt))
                {
                    ...
                    echo "You didn't delete the game!";
                }
                else
                {
                    echo "Deleted game!";
...
<div class="w3-main" style="margin-left:250px">
  ...
  <div class="w3-container w3-center" id="jeans">
    <p><b><font size="6">Delete Game</font></b></p>
  ...
  <div class="w3-content">
	...
	<center>
      <div>
		...
		<input class="w3-button w3-black w3-margin-top" type = "submit" value = "Delete Game">
